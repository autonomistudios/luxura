...
// ─── AI Model IDs ─────────────────────────────────────────────────────────────
// Nano Banana Pro — Stable GA, studio-quality 4K output, reasoning core, best identity lock
// Alt: gemini-3.1-flash-image (Nano Banana 2) — newer, faster, good for previews/batch
export const PXL_MODEL  = "gemini-3-pro-image";

// gemini-2.5-pro — Stable GA, 1M context, sharpest DNA extraction + director briefs
// Next: upgrade to gemini-3.1-pro when available
