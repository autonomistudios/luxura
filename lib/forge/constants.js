...
// ─── AI Model IDs ─────────────────────────────────────────────────────────────
// Highest-quality image generation available — 2K studio-grade output, best identity lock
// Registry: gemini-3-pro-image-preview → upgrade to gemini-3.1-pro-image when GA
export const PXL_MODEL  = "gemini-3-pro-image-preview";

// Best reasoning + vision model — sharper DNA extraction, better director briefs, 1M context
// Registry: gemini-2.5-pro → upgrade to gemini-3.1-pro-preview when stable GA
